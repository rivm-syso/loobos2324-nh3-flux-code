...
##'
#' Author: Kljun et al. (2015), downloaded from https://footprint.kljun.net/
#' Contributions by: 
##'
#' Usage: *NOTE* When using this function, please provide credit to the proper
#'   source by citing  Kljun et al. (2015)
#'   
#'   Kljun, N., Calanca, P., Rotach, M. W., and Schmid, H. P.:
#'   A simple two-dimensional parameterisation for Flux Footprint Prediction 
#'   (FFP), Geosci. Model Dev., 8, 3695-3713, 2015, doi:10.5194/gmd-8-3695-2015
##'
